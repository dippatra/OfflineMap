...
// Create a stroke pattern of a gap followed by a dot.
    ...
    public void animateRoute(GoogleMap googleMap, List<LatLng> bangaloreRoute) {
        ...
        backgroundPolyline.setPattern(PATTERN_POLYLINE_DOTTED);
        backgroundPolyline.setJointType(JointType.ROUND);

        optionsForeground = new PolylineOptions().add(bangaloreRoute.get(0)).color(Color.BLACK).width(20);
        foregroundPolyline = googleMap.addPolyline(optionsForeground);
        foregroundPolyline.setPattern(PATTERN_POLYLINE_DOTTED);
        foregroundPolyline.setJointType(JointType.ROUND);
